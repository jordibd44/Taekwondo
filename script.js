const tecnicasPorNivel = {
        ...
        vocabulario: [
          { nombre: "AN", imagen: "Interior" },
          { nombre: "AP", imagen: "Frontal" },
          { nombre: "ARE", imagen: "Zona Baja" },
          { nombre: "BAKAT", imagen: "Exterior" },
          { nombre: "BANDE", imagen: "Mismo lado pie Adelantado" },
          { nombre: "BARO", imagen: "Distinto lado pie Adelantado" },
          { nombre: "BITURO", imagen: "Retorcer" },
          { nombre: "BO CHUMOK", imagen: "Puño Atesorado" },
          { nombre: "CHECHO", imagen: "Mirando Arriba" },
          { nombre: "CHEVIPUM", imagen: "Girar Cadera" },
          { nombre: "CHIGUI", imagen: "Golpe" },
          { nombre: "CHIRIGUI", imagen: "Pinchar" },
          { nombre: "CHUCHUM", imagen: "Posicion Jinete" },
          { nombre: "DANKIOT", imagen: "Agarrar" },
          { nombre: "DOLLIO", imagen: "Semicírculo" },
          { nombre: "DU", imagen: "Doble" },
          { nombre: "DUNG", imagen: "Parte Superior" },
          { nombre: "FURIO", imagen: "Círculo" },
          { nombre: "GAWI", imagen: "Tijeras" },
          { nombre: "GECHIO", imagen: "Doble Parada" },
          { nombre: "GODURO", imagen: "Apoyo" },
          { nombre: "GONG KIOK", imagen: "Ataque" },
          { nombre: "JIRUGUI", imagen: "Ataque de Puño" },
          { nombre: "KIBON", imagen: "Fundamental" },
          { nombre: "KISUL", imagen: "Técnica" },
          { nombre: "KOA", imagen: "Cruzado" },
          { nombre: "MAKI", imagen: "Parada" },
          { nombre: "ME", imagen: "Parte exterior Puño" },
          { nombre: "MOA", imagen: "Pies Juntos" },
          { nombre: "MONTONG", imagen: "Zona Media" },
          { nombre: "NAKO", imagen: "Gancho" },
          { nombre: "NARANJI", imagen: "Pies Separados Paralelos" },
          { nombre: "NERIO", imagen: "Descender" },
          { nombre: "OKGORRO", imagen: "Diana" },
          { nombre: "OLGUT", imagen: "Zona Alta" },
          { nombre: "OLLIO", imagen: "Ascendente" },
          { nombre: "PIOCHOK", imagen: "Diana" },
          { nombre: "PIONJI", imagen: "Pies Separados" },
          { nombre: "PUM", imagen: "Movimiento Especial" },
          { nombre: "PUMSE", imagen: "Formas" },
          { nombre: "SEUO", imagen: "Vertical" },
          { nombre: "SOGUI", imagen: "Posición" },
          { nombre: "TUIO", imagen: "Salto" },
          { nombre: "TUIT", imagen: "Atrás" },
          { nombre: "YOP", imagen: "Lateral" },
          { nombre: "BAL", imagen: "Pie" },
          { nombre: "BTANGSON", imagen: "Palma de la Mano" },
          { nombre: "CHUMOK", imagen: "Puño Atesorado" },
          { nombre: "DARI", imagen: "Pierna" },
          { nombre: "KUT", imagen: "Dedo" },
          { nombre: "MOK", imagen: "Cuello" },
          { nombre: "MOM", imagen: "Cuerpo" },
          { nombre: "PALKUP", imagen: "Codo" },
          { nombre: "SONNAL", imagen: "Mano" },
          { nombre: "MURUP", imagen: "Rodilla" },
          { nombre: "CHARYOT", imagen: "Firmes" },
          { nombre: "CHUMBI", imagen: "Preparados" },
          { nombre: "GUMAN", imagen: "Final" },
          { nombre: "KALYO", imagen: "Parar" },
          { nombre: "KESOK", imagen: "Continuar" },
          { nombre: "KONIEK", imagen: "Saludo" },
          { nombre: "SIGAN", imagen: "Tiempo Parado" },
          { nombre: "SIJAK", imagen: "Comenzar" },
          { nombre: "IL", imagen: "Primero" },
          { nombre: "I", imagen: "Segundo" },
          { nombre: "SAM", imagen: "Tercero" },
          { nombre: "SA", imagen: "Cuarto" },
          { nombre: "OH", imagen: "Quinto" },
          { nombre: "YOUK", imagen: "Sexto" },
          { nombre: "CHILL", imagen: "Séptimo" },
          { nombre: "PAL", imagen: "Octavo" },
          { nombre: "CHONG", imagen: "Azul" },
          { nombre: "HONG", imagen: "Rojo" },
          { nombre: "SABONIM", imagen: "Maestro" },
          { nombre: "DO CHANG", imagen: "Sala de Entreno" },
          { nombre: "DOBOK", imagen: "Traje de Taekwondo" },
          { nombre: "TI", imagen: "Cinturón" },
          { nombre: "PAO", imagen: "Saco de Mano" },
          { nombre: "ORUM", imagen: "Derecha" },
          { nombre: "UEN", imagen: "Izquierda" }
        ]
    };
    ...
    function seleccionarNivel(nivel) {
      ...
      if (nivel === "vocabulario") {
        // Solo usa las técnicas del vocabulario, sin mezcla
        tecnicasDisponibles = [...(tecnicasPorNivel["vocabulario"] || [])];
      } else {
        // Junta todas las técnicas hasta el nivel seleccionado
    ...
    function siguienteTecnica() {
        if (tecnicasDisponibles.length === 0) {
            alert("¡Has completado todas las técnicas disponibles para este nivel!");
            reiniciar();
            return;
        }
        ...
        // Eliminar técnica mostrada para evitar repetición
        tecnicasDisponibles.splice(random, 1);  
    ...
    function mostrarImagen() {
      if (tecnicaActual) {
        if (nivelSeleccionado === "vocabulario") {
          document.getElementById('tecnicaImagen').innerHTML = `
            <p><strong>Traducción:</strong> ${tecnicaActual.imagen}</p>
          `;
        } else {
          document.getElementById('tecnicaImagen').innerHTML = `
    ...
    function reiniciar() {
      ...
      document.getElementById('modoEstudio').style.display = 'none';
      tecnicaActual = null;
      nivelSeleccionado = null;
      tecnicasDisponibles = [];
    }

function modoEstudiar() {
  // Oculta los otros menús
  document.getElementById('niveles').style.display = 'none';
  document.getElementById('contenido').style.display = 'none';
  document.getElementById('modoEstudio').style.display = 'flex';

  const tabla = document.getElementById('tablaEstudio');
  tabla.innerHTML = ''; // Limpiar

  // Mostrar técnicas por nivel
  for (const nivel of ordenNiveles) {
    if (!tecnicasPorNivel[nivel] || tecnicasPorNivel[nivel].length === 0) continue;

    const seccion = document.createElement('div');
    seccion.innerHTML = `<h3>${nivel.toUpperCase()}</h3>`;

    const grid = document.createElement('div');
    grid.className = 'tecnica-grid';

    tecnicasPorNivel[nivel].forEach(tecnica => {
      const card = document.createElement('div');
      card.className = 'tecnica-card';
      card.innerHTML = `
        <strong>${tecnica.nombre}</strong><br>
        <img src="${tecnica.imagen}" alt="${tecnica.nombre}">
      `;
  ...
  // Mostrar vocabulario
  if (tecnicasPorNivel["vocabulario"] && tecnicasPorNivel["vocabulario"].length > 0) {
    const vocabSeccion = document.createElement('div');
    vocabSeccion.innerHTML = `<h3>VOCABULARIO</h3>`;

    const tablaVocabulario = document.createElement('table');
    tablaVocabulario.innerHTML = '<tr><th>Palabra</th><th>Traducción</th></tr>';

    tecnicasPorNivel["vocabulario"].forEach(entrada => {
      const fila = document.createElement('tr');
      fila.innerHTML = `<td>${entrada.nombre}</td><td>${entrada.imagen}</td>`; // imagen = traducción
      tablaVocabulario.appendChild(fila);
    });

    vocabSeccion.appendChild(tablaVocabulario);
    tabla.appendChild(vocabSeccion);
  }
}
